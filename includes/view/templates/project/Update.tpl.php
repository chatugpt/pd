 <div style="width: 99%;" id="listbox"> <div style="width: 99%;" id="listbox">

<form name="actionForm" action="<?php echo zee::url(project, "update_submit");?>" method="post">
...
<!-- fields start -->
		<tr>
			<td class="menumaintopon" colspan="2"><?php Language::show("PROJECT.UPDATE.LABEL")?></td>
		</tr>
					<tr>
...
<input type="hidden"  name="project_project_id" value="<?php echo $outProjectUpdateValue->project_id?>" /><?php echo $outProjectUpdateValue->project_id?>
...
<?php Errors::show("PROJECT_ID")?>
					...
					<tr>
						...
						<td align="left" class="smalltdrow2">
<input type="text" class="textinput" name="project_project_name" value="<?php echo $outProjectUpdateValue->project_name?>" />
